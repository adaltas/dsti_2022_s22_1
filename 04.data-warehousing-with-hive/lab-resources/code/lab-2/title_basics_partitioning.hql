CREATE TABLE IF NOT EXISTS dsti_2022_s22_1.imdb_title_basics_decade (
  tconst STRING,
  titletype STRING,
  primarytitle STRING,
...
INSERT OVERWRITE TABLE dsti_2022_s22_1.imdb_title_basics_decade
SELECT
  tconst, titletype, primarytitle, originaltitle, isadult,
  startyear, endyear, runtimeminutes, genres,
  CASE
    -- Grouping titles created before 1940 into a single partition
